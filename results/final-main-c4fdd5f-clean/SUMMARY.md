...
| --- | ---: | ---: | ---: |
| Process start → `pnpm:scope` | 2146.50 ms | 999.50 ms | -53.44% |
| Process wall time | 2779.33 ms | 1621.51 ms | -41.66% |

Standard deviation for scope was 316.40 ms on latest main and 302.56 ms on the candidate.
